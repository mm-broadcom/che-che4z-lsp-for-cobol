...
describe("Validate ensureIndicatorArea", () => {
  test("with '       MOVE 1 to 2.'", () => {
    expect(ensureIndicatorArea("       MOVE 1 to 2.")).toBe(
      "       MOVE 1 to 2.",
    );
  });
  test("with '123456 MOVE 1 to 2.'", () => {
    expect(ensureIndicatorArea("123456 MOVE 1 to 2.")).toBe(
      "123456 MOVE 1 to 2.",
    );
  });
  test("with '       CBL FOO.'", () => {
...
describe("Validate getLineCommentStatus", () => {
  ...
  test("with debug line", () => {
    expect(getLineCommentStatus('123456D    Display "Hello!"')).toBe(
      LineCommentStatus.OTHER_TYPE,
    );
  });
...
describe("Validate commentLine", () => {
  ...
  test("with non comment line", () => {
    expect(commentLine("123456  MOVE 1 TO SOME.")).toBe(
      "123456* MOVE 1 TO SOME.",
    );
  });
  test("with empty line", () => {
...
describe("Validate uncommentLine", () => {
  ...
  test("with non comment line", () => {
    expect(uncommentLine("123456  MOVE 1 TO SOME.")).toBe(
      "123456  MOVE 1 TO SOME.",
    );
  });
  test("with empty line", () => {
