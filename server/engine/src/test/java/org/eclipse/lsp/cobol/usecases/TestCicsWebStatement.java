...
public class TestCicsWebStatement {
    ...
    private static final String SEND_CLIENT_VALID_2 = WEB + "SEND FROM(123) FROMLENGTH(3) CHUNKYES GET PATH(123) PATHLENGTH(123) QUERYSTRING(123) QUERYSTRLEN(123) DOCTOKEN(123) DOCDELETE CLICONVERT CHARACTERSET(1) EXPECT NOCLOSE BASICAUTH USERNAME(123) USERNAMELEN(3) PASSWORD(1234) PASSWORDLEN(4)";

    private static final String STARTBROWSE_FORMFIELD_VALID = WEB + "FORMFIELD(123) NAMELENGTH(123) CHARACTERSET(123) HOSTCODEPAGE(123)";
    private static final String STARTBROWSE_HTTPHEADER_VALID = WEB + "HTTPHEADER SESSTOKEN({$sessVar})";
    private static final String STARTBROWSE_QUERYPARM_VALID = WEB + "QUERYPARM(123) NAMELENGTH(123) HOSTCODEPAGE(123)";
